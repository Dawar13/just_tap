      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative h-[400px] lg:h-[500px] flex items-center justify-center">
            {/* Back Card */}
            <div className="absolute w-64 sm:w-72 h-[380px] sm:h-[420px] bg-black rounded-2xl transform -rotate-6 translate-x-8 shadow-2xl flex flex-col justify-between p-6">
            ...
            {/* Front Card */}
            <div className="absolute w-64 sm:w-72 h-[380px] sm:h-[420px] bg-primary rounded-2xl transform rotate-6 -translate-x-8 shadow-[0_20px_50px_-12px_rgba(253,106,24,0.5)] flex flex-col justify-between p-6 overflow-hidden">
